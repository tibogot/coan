...
const Footer = () => {
  return (
    <footer className="min-h-screen bg-[#0F0F0F] px-10 py-12 text-white">
      {/* Newsletter Signup */}
      ...
      <div className="absolute right-10 bottom-10 left-10 mt-12 flex justify-between border-t border-gray-700 pt-6 text-center text-sm text-gray-400">
        ...
        <div className="flex gap-6">
          ...
          <p className="cursor-pointer hover:text-white">Privacy & cookies</p>
          <p className="cursor-pointer hover:text-white">Cookie declaration</p>
        </div>
      </div>
    </footer>
  );
